"""
embedder.py — Generate embeddings using sentence-transformers (Async-friendly).
"""
...
async def embed_chunks(chunks: list[dict], batch_size: int = 64) -> np.ndarray:
    """Encode a list of code chunks into embedding vectors asynchronously.
    ...
    # model.encode is CPU-bound and synchronous. 
...
async def embed_query(query: str) -> np.ndarray:
    """Encode a single user query into an embedding vector asynchronously.
